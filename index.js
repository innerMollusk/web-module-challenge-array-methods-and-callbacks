...
function getWinnersByYear(array, cbGF, cbGY, cbGW) {
   const winners = cbGW(array, cbGF);
   const years = cbGY(array, cbGF);
...
function getAverageGoals(cbGF) {
    const averageHomeGoals = cbGF.reduce(function(acc, item) {
    return acc + item["Home Team Goals"] + item["Away Team Goals"];
    }, 0)
    return (averageHomeGoals / cbGF.length).toFixed(2);
}
